  ...
  return (
    <Container maxWidth="xs">
      ...
      <form onSubmit={handleSubmit}>
        <TextField name="description" label="Description" fullWidth margin="normal" value={cropData.description} onChange={handleChange} />
        <TextField name="price" label="Price" type="number" fullWidth margin="normal" value={cropData.price} onChange={handleChange} />
        <Input type="file" inputProps={{ multiple: true }} onChange={handlePhotoChange} />
